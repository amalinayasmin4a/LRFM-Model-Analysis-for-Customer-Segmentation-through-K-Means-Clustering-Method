# LRFM-Model-Analysis-for-Customer-Segmentation-through-K-Means-Clustering-Method
...
## Project Objectives
- Calculate LRFM metrics from transaction data  
- Explore customer patterns through unsupervised learning  
- Compare clustering algorithms and evaluate segment quality  
- Provide insights useful for marketing, retention, and customer value strategies  

---

## Main Features
- **Data Cleaning & Preprocessing**: Handling missing values, merging datasets, and preparing LRFM features  
- **Feature Engineering**: LRFM metric creation and scaling  
